...
```bash
# replace your_email@example.com, this is purely informative and allows you to remember the use of this key
ssh-keygen -t ed25519 -f ~/.ssh/da-bootcamp -C your_email@example.com
```

Your new SSH Key will be named `da-bootcamp`. Make sure to remember it for later!
</details>
...
``` bash
pip install -r https://github.com/lewagon/data-analytics-setup/blob/no-update-2026/specs/releases/linux.txt
```
...
```bash
zsh -c "$(curl -fsSL https://github.com/lewagon/data-analytics-setup/blob/no-update-2026/checks/python_checker.sh)" 3.12.9
```

Run the following command to check if you successfully installed the required packages:

```bash
zsh -c "$(curl -fsSL https://github.com/lewagon/data-analytics-setup/blob/no-update-2026/checks/pip_check.sh)"
```

Now run the following command to check if you can load these packages:

```bash
python -c "$(curl -fsSL https://github.com/lewagon/data-analytics-setup/blob/no-update-2026/checks/pip_check.py)"
```
